...
void NotationParts::setInstrumentVisible(const QString& partId, const QString& instrumentId, bool visible)
{
    ...
    m_instrumentChanged.send(convertedInstrument(instrumentInfo.instrument, part));
    m_partsChanged.notify();
}
...
void NotationParts::setInstrumentName(const QString& partId, const QString& instrumentId, const QString& name)
{
    ...
    m_instrumentChanged.send(convertedInstrument(newInstrumentInfo.instrument, part));
    m_partsChanged.notify();
}
...
const Staff* NotationParts::appendStaff(const QString& partId, const QString& instrumentId)
{
    ...
    m_instrumentChanged.send(convertedInstrument(instrument, part));
    m_partsChanged.notify();
...
const Staff* NotationParts::appendLinkedStaff(int staffIndex)
{
    ...
    m_instrumentChanged.send(convertedInstrument(instrumentInfo.instrument, staff->part()));
    m_partsChanged.notify();
...
void NotationParts::doRemoveStaves(const std::vector<int>& stavesIndexes)
{
    for (int staffIndex: stavesIndexes) {
        ...
        m_instrumentChanged.send(convertedInstrument(instrument, staff->part()));
    }
}
...
void NotationParts::moveStaves(const std::vector<int>& stavesIndexes, int toStaffIndex, InsertMode mode)
{
    ...
    m_instrumentChanged.send(convertedInstrument(fromInstrument, fromPart));
    m_instrumentChanged.send(convertedInstrument(toInstrument, toPart));
    m_partsChanged.notify();
}
