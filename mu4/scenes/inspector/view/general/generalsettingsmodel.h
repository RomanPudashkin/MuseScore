...
public slots:
    ...
    void setAppearanceSettingsModel(mu::scene::inspector::AppearanceSettingsModel* appearanceSettingsModel);
...
private:
    ...
    mu::scene::inspector::AppearanceSettingsModel* m_appearanceSettingsModel = nullptr;
};
