...
public:
    ...
    Q_INVOKABLE QStringList timeSignatureDenominators();

    bool timeCommon() const;
    bool timeCut() const;
...
public slots:
    ...
    void setTimeFraction(bool timeFraction);
    void setTimeCommon(bool timeCommon);
    void setTimeCut(bool timeCut);
