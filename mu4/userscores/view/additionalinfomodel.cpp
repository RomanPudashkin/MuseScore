...
#include "ui/view/musicalsymboliconcodes.h"
...
{
    static QMap<QString, MusicalSymbolIconCode::Code> numeralsMusicSymbols = {
        { "0", MusicalSymbolIconCode::Code::ZERO },
        { "1", MusicalSymbolIconCode::Code::ONE },
        { "2", MusicalSymbolIconCode::Code::TWO },
        { "3", MusicalSymbolIconCode::Code::THREE },
        { "4", MusicalSymbolIconCode::Code::FOUR },
        { "5", MusicalSymbolIconCode::Code::FIVE },
        { "6", MusicalSymbolIconCode::Code::SIX },
        { "7", MusicalSymbolIconCode::Code::SEVEN },
        { "8", MusicalSymbolIconCode::Code::EIGHT },
        { "9", MusicalSymbolIconCode::Code::NINE },
    };

    QVariantList result;
    QString numberStr = QString::number(number);
    for (const QString& numeral: numberStr) {
        result << static_cast<int>(numeralsMusicSymbols[numeral]);
    }
...
{
    QVariantList marks;
    marks << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::SEMIQUAVER) } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::SEMIQUAVER) }, { "withDot", true } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::CROTCHET) } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::CROTCHET) }, { "withDot", true } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::QUAVER) } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::QUAVER) }, { "withDot", true } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::MINIM) } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::MINIM) }, { "withDot", true } }
          << QVariantMap { { "icon", static_cast<int>(MusicalSymbolIconCode::Code::SEMIBREVE) } };
