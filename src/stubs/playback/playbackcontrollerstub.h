...
public:
    ...
    void playElements(const std::vector<const notation::EngravingItem*>& elements, const PlayParams& params = PlayParams(),
                      bool isMidi) override;
    void playNotes(const notation::NoteValList& notes, const notation::staff_idx_t staffIdx, const notation::Segment* segment,
